...
\subsection{Beamer Examples}
% ARFC Team: Some good examples of how to use beamer are in the following 
% slides. You can use them to guide the preparation of slides.
